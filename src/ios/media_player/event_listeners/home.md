...
EventListener는 이벤트 처리를 위한 프로토콜로, 다음과 같은 함수를 제공합니다. 각각 함수에 대한 자세한 설명은 [이벤트 핸들러](../event_handlers/home.md)를, 사용 방법은 [addEventListener(_)](../methods/details.md#addeventlistener_)를 참고하시면 됩니다.
