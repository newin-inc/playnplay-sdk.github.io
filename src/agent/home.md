...
|useBookmarkCallback| boolean \| undefined| 북마크 콜백 URL 사용 (옵션)<br />참고: 이 필드를 설정하면 PlaynPlay의 북마크 연동 기능이 비활성화됩니다. 북마크 데이터 [제공 Callback](../callback-url/get-bookmarks.html)과 [저장 Callback](../callback-url/update-bookmarks.html) 구현해야 합니다.|
