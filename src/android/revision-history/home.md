...
| 날짜 | 변경 내용 |
|:--:|--|
|[2024.08.30.](https://app.playnplay.com/sdks/2024-08-29/NPlayerSDK-android.zip)|<ul><li>오디오 포커스 관련 문제 수정<ul><li>통화 시 영상 일시 정지, 통화 종료 시 영상 재개 기능 추가</li></ul></li><li>화면 확대/축소, 비디오 팬 기능 추가</li></ul>|
